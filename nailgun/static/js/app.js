    ...
    var AppRouter = Backbone.Router.extend({
        ...
        showClusterTab: function(id, activeTab) {
            ...
            if (app.page && app.page.constructor == ClusterPage && app.page.model.id == id) {
                ...
                $.when(cluster.fetch(), cluster.fetchRelated('nodes'), cluster.fetchRelated('tasks'), app.navbar.tasks.fetch({data: {cluster_id: ''}}))
        ...
        listReleases: function() {
            ...
            $.when(releases.fetch(), app.navbar.tasks.fetch({data: {cluster_id: ''}})).done(_.bind(function() {
